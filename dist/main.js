...
const UMSTenant = (props) => {
    ...
    return (react_1.default.createElement(components_1.WidgetWrapper, null,
        ...
        react_1.default.createElement(components_1.DataTable, { className: 'tenants', activeClass: "active", data: tenants, pageSize: 5, onClickRow: item => {
                setAddMeter(true);
...
"use strict";
module.exports = JSON.parse('{"id":"dece8055-b3de-42ec-b596-8ffa8fd0a794","author":"","widgets":[{"id":"ums_tenant","name":"UMS Tenant","description":"UMS Tenant","icon":"","tags":[]}],"sidebarLinks":[],"uis":[],"menuItems":[]}');
